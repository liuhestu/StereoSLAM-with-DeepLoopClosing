...
int main(int argc, char **argv){
    ...
    std::string saveFile = "result/KeyTrajectory.txt";
    slam->SaveKeyTrajectory(saveFile);

    // save the frame trajectory
    std::string saveFrameFile = "result/FrameTrajectory.txt";
    slam->SaveFrameTrajectory(saveFrameFile);
