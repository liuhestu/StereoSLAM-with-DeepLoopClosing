...
public:
     ...
     */
    void SaveKeyTrajectory(std::string &save_file);

    /* save all tracked frame trajectory to a txt file
     */
    void SaveFrameTrajectory(std::string &save_file);
...
private:
    ...
    std::vector<Frame::Ptr> _mvAllFrames;
    std::mutex _mmutexAllFrames;
